namespace CocktailParty
{
    ...
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            Ingredient milk = new Ingredient("Milk", 8, 5);
            //Ingredient smth = new Ingredient("Whiskey", 5, 5);
            //Ingredient second = new Ingredient("Romm", 5, 5);
           // Ingredient secMilk = new Ingredient("Milk", 0, 5);

            //Add ingredients
            cocktail.Add(vodka);
            cocktail.Add(milk);
            //cocktail.Add(secMilk);
            //cocktail.Add(smth);
            //cocktail.Add(second);
